...
//color change, appears different pattern
  background(300);
  noFill(0);
  stroke(0);  
    ...
    for (i=0; i<500; i=i+4) {
      ...
      stroke(300); 
      //shadow
      rect(130+i/3-30,250+i-50 ,100 ,70)
      rect(470+i/-3-30,250+i-50 ,100 ,70)
      rect(480+i/3-30,250+i-50 ,100 ,70)
      rect(820+i/-3-30,250+i-50 ,100 ,70)
